...
export function UploadPhotosDialog({ job, isOpen, onClose, onUpload }: UploadPhotosDialogProps) {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl overflow-hidden">
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
            <Camera className="w-5 h-5 text-green-500" /> Upload Photos — {job.vehicle}
          </h2>
        ...
        <div className="p-5 space-y-4">
          <div className="grid grid-cols-3 gap-3">
            ...
            <button
              ...
              className="aspect-square flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg hover:border-yellow-400 hover:bg-yellow-50 transition-colors text-gray-400 cursor-pointer"
            >
