...
export function UnassignJobPage() {
  ...
  const unassignedJobs = jobCards.filter((j) => {
    ...
    return isUnassigned && priorityMatch && searchMatch;
  });

  if (isLoading) return <div className="p-8 text-center text-gray-500">Loading unassigned jobs...</div>;
  ...
  return (
    <div className="p-8 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Unassign Job</h1>
      </div>
